			...
			if (playerTurn)
			{
				...
				switch (selectedPokemons[0].move4)
				{
					...
					case "Growl":
						...
						{
							enemyPokemons[enemyIndex].move1Damage = enemyPokemons[enemyIndex].move1Damage - 20;
							enemyPokemons[enemyIndex].move2Damage = enemyPokemons[enemyIndex].move2Damage - 20;
							enemyPokemons[enemyIndex].move3Damage = enemyPokemons[enemyIndex].move3Damage - 20;
							enemyPokemons[enemyIndex].move4Damage = enemyPokemons[enemyIndex].move4Damage - 20;
							attackFell = true;
							EnemyPokemonFaints();
							turnTimer.Start();
							EnemyAttackFell();
					...
					case "Charge":
						...
						{
							selectedPokemons[0].defense = selectedPokemons[0].defense + 20;
						}
						EnemyPokemonFaints();
						turnTimer.Start();
						MoveDelayStart();
		...
		private void BtnMove4_MouseHover(object sender, EventArgs e)
		{
			...
			switch (selectedPokemons[0].move4)
			{
				...
				case "Growl":
					lblInfo.Size = new Size(504, 108);
					lblInfo.Location = new System.Drawing.Point(9, 373);
					lblInfo.Text = "Growl lowers the target's Attack by 20. It can be lowered 3 times.";
					break;

				case "Charge":
					lblInfo.Size = new Size(504, 108);
					lblInfo.Location = new System.Drawing.Point(9, 373);
					lblInfo.Text = "Charge raises the user's Defense by 20, and if this Pokémon's next move is a damage-dealing Electric-type attack, it will deal double damage.";
					break;
